...
var tables = Excel.ReadWithEPPlus<List<DataTable>>(materialsFile);
...
File.WriteAllText($"{materialsFile?.Substring(0, materialsFile.Length - 4)}-анализ.csv", sb.ToString(), Excel.srcEncoding);