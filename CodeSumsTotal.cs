...
namespace ExcelUtils
{
    ...
    {
        public static void AddHeader(string file)
        {
            ...
            using (ExcelPackage package = new ExcelPackage(new FileInfo(file)))
            {
                ...
                if (a1 == "Код")
                {
                    ...
                    worksheet.Cells[1, 2].Value = "ОБЩO";
                    //worksheet.Cells[1, 2].Style.Font.Bold = true;
                    worksheet.Cells[2, 2].Value = "НА ПЕРСОНАЛА";
                    worksheet.Cells[3, 2].Value = $"{podName}{podNumberStr}";
                    string period = "МЕСЕЦ";
        ...
        internal static void AddSumsByCode(string file, Dictionary<Tuple<int, string>, CodeSum> codesSums)
        {
            using (ExcelPackage package = new ExcelPackage(new FileInfo(file)))
            {
                ...
                for (int i = 7; i <= worksheet.Dimension.End.Row; i++)
                {
                    ...
                    Tuple<int, string> key = new Tuple<int, string>(code, name);
        ...
        internal static void InsertCodesSumsInXlsx(Dictionary<Tuple<int, string>, CodeSum> codesSums, string fileName)
        {
