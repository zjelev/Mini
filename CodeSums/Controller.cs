...
public class Controller
{
    public static void AddHeader(string file)
    {
        ...
        int year;
        Util.GetHeader(file, out fileName, out year, out month, out podName, out podNumberStr);
    ...
    internal static void InsertCodesSums(Dictionary<(int, string), CodeSum> codesSums, string fileName)
    {
